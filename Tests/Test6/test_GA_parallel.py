...
from Core import dispatcher_GA
...
class MyProblem(Problem):
    ...
    def __init__(self, design, **kwargs):
        self.design = design  # store the design object as an attribute
        super().__init__(n_var=3, n_obj=2, xl=[0.,0.,20.], xu = [2000.,200.,80.], **kwargs)
