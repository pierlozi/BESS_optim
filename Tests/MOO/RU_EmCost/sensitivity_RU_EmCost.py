...
df = pd.read_excel('test_NSGAII_RU_EmCost.xlsx', index_col = 0, header= 0)

df_sorted = df.sort_values(by=['RU'], ignore_index=True)
...
chart_sensit
#%%
chart_sensit.save('sensit_RU_EmCost.png')
